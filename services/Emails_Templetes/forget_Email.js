async function forget_Email_Body(data) {
  return (
    `<p style='margin-top:0in;margin-right:0in;margin-bottom:8.0pt;margin-left:0in;line-height:107%;font-size:15px;font-family:"Calibri",sans-serif;text-align:center;'><strong><span style='font-size:19px;line-height:107%;font-family:"Calibri Light",sans-serif;color:#D50101;'>latestlocaldealz.com.au</span></strong></p>
...
module.exports.forget_Email_Body = forget_Email_Body;
